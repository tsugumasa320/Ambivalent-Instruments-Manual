...
- **Grainer**: Smoother transitions when entering or leaving freeze, reducing seams and edge clicks, and fixed a bug where pressing Freeze reset the reverb state.
