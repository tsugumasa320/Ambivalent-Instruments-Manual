...
Repitch、Fade、Reverse、Ping-pongの4つのディレイ・モードを備えたプロフェッショナルなステレオ・ディレイ・エンジンです。高品質なオーディオ処理を実現する3次ラグランジュ補間を採用し、Ableton Liveにインスパイアされたデザインです。
...
- ディレイ・タイムの制御（秒単位で表示：0.010秒〜5.000秒）
- 音楽的なレスポンスのための指数カーブ
- CV入力対応
- 範囲：10ミリ秒〜5秒
